...
class Classic_Editor {
	...
	public static function register_settings() {
		...
		register_setting( 'writing', 'navigation-editor-replace', array(
			'sanitize_callback' => array( __CLASS__, 'validate_option_navigation' ),
		) );

		register_setting( 'writing', 'widgets-editor-replace', array(
			'sanitize_callback' => array( __CLASS__, 'validate_option_widgets' ),
		) );
		...
		$allowed_options = array(
			'writing' => array(
				...
				'navigation-editor-replace',
				'widgets-editor-replace',
		...
		$heading_3 = __( 'Navigation editor for all users', 'classic-editor' );
		$heading_4 = __( 'Widget editor for all users', 'classic-editor' );
		...
		add_settings_field( 'classic-editor-4', $heading_4, array( __CLASS__, 'settings_4' ), 'writing' );
	}
	...
	public static function save_user_settings( $user_id ) {
		if (
			...
			$navigation_editor = self::validate_option_navigation( $_POST['navigation-editor-replace'] );
			$widgets_editor = self::validate_option_widgets( $_POST['widgets-editor-replace'] );
			update_user_option( $user_id, 'classic-editor-settings', $editor );
			update_user_option( $user_id, 'navigation-editor-settings', $navigation_editor );
			update_user_option( $user_id, 'widgets-editor-settings', $widgets_editor );
		}
	}
	...
	public static function validate_option_navigation( $value ) {
		if ( $value === 'block' ) {
			return 'block';
		}
	...
	public static function validate_option_widgets( $value ) {
		if ( $value === 'block' ) {
			return 'block';
		}
	...
	public static function settings_1() {
		...
		<div class="classic-editor-options">
			<p>
				...
				<label for="classic-editor-classic"><?php _ex( 'Classic post editor', 'Editor Name', 'classic-editor' ); ?></label>
			</p>
			<p>
	...
	public static function settings_3() {
		...
		?>
		<div class="navigation-editor-options">
			<p>
				<input type="radio" name="navigation-editor-replace" id="navigation-editor-classic" value="classic"<?php if ( $settings['editor'] === 'classic' ) echo ' checked'; ?> />
				<label for="navigation-editor-classic"><?php _ex( 'Classic navigation editor', 'Editor Name', 'classic-editor' ); ?></label>
			</p>
			<p>
				<input type="radio" name="navigation-editor-replace" id="navigation-editor-block" value="block"<?php if ( $settings['editor'] !== 'classic' ) echo ' checked'; ?> />
				<label for="navigation-editor-block"><?php _ex( 'Block editor', 'Editor Name', 'classic-editor' ); ?></label>
			</p>
		</div>
		<script>
		jQuery( 'document' ).ready( function( $ ) {
			if ( window.location.hash === '#navigation-editor-options' ) {
				$( '.navigation-editor-options' ).closest( 'td' ).addClass( 'highlight' );
			}
		} );
		</script>
		<?php
	...
	public static function settings_4() {
		$settings = self::get_settings( 'refresh' );

		?>
		<div class="widgets-editor-options">
			<p>
				<input type="radio" name="widgets-editor-replace" id="widgets-editor-classic" value="classic"<?php if ( $settings['editor'] === 'classic' ) echo ' checked'; ?> />
				<label for="widgets-editor-classic"><?php _ex( 'Classic widgets editor', 'Editor Name', 'classic-editor' ); ?></label>
			</p>
			<p>
				<input type="radio" name="widgets-editor-replace" id="widgets-editor-block" value="block"<?php if ( $settings['editor'] !== 'classic' ) echo ' checked'; ?> />
				<label for="widgets-editor-block"><?php _ex( 'Block editor', 'Editor Name', 'classic-editor' ); ?></label>
			</p>
		</div>
		<script>
		jQuery( 'document' ).ready( function( $ ) {
			if ( window.location.hash === '#widgets-editor-options' ) {
				$( '.widgets-editor-options' ).closest( 'td' ).addClass( 'highlight' );
			}
		} );
		</script>
		<?php
	...
	public static function activate() {
		...
		if ( is_multisite() ) {
			...
			add_network_option( null, 'widget-editor-replace', 'classic' );
			add_network_option( null, 'navigation-editor-replace', 'classic' );
		...
		add_option( 'widget-editor-replace', 'classic' );
		add_option( 'navigation-editor-replace', 'classic' );
	}
	...
	public static function uninstall() {
		if ( is_multisite() ) {
			...
			delete_network_option( null, 'navigation-editor-replace' );
			delete_network_option( null, 'widget-editor-replace' );
			delete_network_option( null, 'classic-editor-allow-sites' );
		}

		delete_option( 'classic-editor-replace' );
		delete_option( 'widget-editor-replace' );
		delete_option( 'navigation-editor-replace' );
